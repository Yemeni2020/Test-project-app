...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 26, 2024 at 11:43 AM
...
ALTER TABLE `likes_dislikes`
  ...
  ADD CONSTRAINT `likes_dislikes_ibfk_2` FOREIGN KEY (`comment_id`) REFERENCES `comments` (`id`);
...
ALTER TABLE `reports`
  ...
  ADD CONSTRAINT `reports_ibfk_2` FOREIGN KEY (`comment_id`) REFERENCES `comments` (`id`);
COMMIT;
